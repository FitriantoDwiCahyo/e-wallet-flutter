...
class TransferAmountScreen extends StatefulWidget {
  static const routeName = '/transfer-amount';
  const TransferAmountScreen({Key? key}) : super(key: key);

  @override
  State<TransferAmountScreen> createState() => _PinScreenState();
}

class _PinScreenState extends State<TransferAmountScreen> {
            ...
            onPressed: () async {
              if (await Navigator.of(context).pushNamed(PinScreen.routeName) ==
                ...
                await Navigator.of(context).pushNamedAndRemoveUntil(
                    TransferSuccessScreen.routeName, (route) => false);
              }
            },
          ),
          const SizedBox(
